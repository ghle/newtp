<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\newtp5\public/../application/index\view\index\update_art.html";i:1521119024;}*/ ?>
<!--_meta 作为公共模版分离出去-->
...
<form class="form form-horizontal" id="form-article-add" >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="authors" name="author">
			</div>
		</div>
	
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button  class="btn btn-primary radius" id="datas" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>
...
<script type="text/javascript" src="/newtp5/public/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer /作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/newtp5/public/lib/My97DatePicker/4.8/WdatePicker.js"></script>
<script type="text/javascript" src="/newtp5/public/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="/newtp5/public/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="/newtp5/public/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="/newtp5/public/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<!-- <script type="text/javascript" src="/newtp5/public/lib/ueditor/1.4.3/ueditor.config.js"></script> 
<script type="text/javascript" src="/newtp5/public/lib/ueditor/1.4.3/ueditor.all.min.js"> </script> 
<script type="text/javascript" src="/newtp5/public/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script> -->
...
$(function(){
	 		...
	 		$.ajax({
				...
				success:function (res) {
					...
					$('#articletitle').val(res.data[1].tittle);
					$('#articletitle2').val(res.data[1].linfo);
					$('.textarea').val(res.data[1].content);
					$('#authors').val(res.data[1].author);
	 		...
	 		$("#datas").click(function () {
			 	$.ajax({
					type:'PUT',
					url:'http://localhost/newtp5/public/update',
					data:{		
								id:46,
								tittle:$('#articletitle').val(),
					...
					success:function (res) {
						...
						console.log(a);
							if(a.code==200){
								...
								// parent.layer.close(index); window.location.reload();
							}
					},
					error:function (res) {
						console.log(res);
