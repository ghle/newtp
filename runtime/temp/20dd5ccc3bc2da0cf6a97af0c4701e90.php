<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\phpStudy\WWW\newtp5\public/../application/index\view\index\index.html";i:1520947622;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt>
			<i class="Hui-iconfont">&#xe616;</i> 文章管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="<?php echo url('lists_art'); ?>" data-title="资讯管理" href="javascript:void(0)">新闻管理</a></li>
				</ul>
